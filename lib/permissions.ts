...
export async function initializeSystemPermissions() {
  try {
    ...
    const systemPermissions = [
      ...
      // Queue
      { name: 'จัดการคิว', code: 'queue.manage', category: 'queue', isSystem: true },
      { name: 'ดูคิว', code: 'queue.view', category: 'queue', isSystem: true },

      // Story
      { name: 'บันทึกสตอรี่', code: 'story.create', category: 'story', isSystem: true },
      { name: 'ดูสตอรี่', code: 'story.view', category: 'story', isSystem: true },
