...
import { DOCTOR_RANKS } from '@/lib/doctor-ranks';
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
              ...
              <p className="text-gray-600">สร้างบัญชีแพทย์ใหม่ในระบบ</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-4">
              <h2 className="text-lg font-semibold text-white">ข้อมูลบัญชีแพทย์</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    value={formData.doctorRank}
                    onChange={(e) => setFormData({ ...formData, doctorRank: e.target.value })}
                ...
                <p className="text-xs text-gray-500 ml-7">เลือกตำแหน่งแพทย์ในโรงพยาบาล</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="กรอกชื่อ-นามสกุลตามบัตรประชาชน (เช่น นายแพทย์ สมชาย ใจดี)"
                />
              ...
              <div className="space-y-2">
                <label className="flex items-center space-x-2 text-sm font-semibold text-gray-700">
                  <User className="w-5 h-5 text-blue-600" />
                  <span>User หมอ <span className="text-red-500">*</span></span>
                </label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all bg-white text-gray-900 placeholder-gray-400 hover:border-gray-300"
                  placeholder="กรอกชื่อผู้ใช้สำหรับเข้าสู่ระบบ (เช่น doctor01)"
                />
                <p className="text-xs text-gray-500 ml-7">ชื่อผู้ใช้ที่แพทย์จะใช้สำหรับเข้าสู่ระบบ</p>
              </div>
              ...
              <div className="space-y-2">
                <label className="flex items-center space-x-2 text-sm font-semibold text-gray-700">
                  ...
                  <span>รหัส Login หมอ <span className="text-red-500">*</span></span>
                </label>
                <PasswordInput
                  required
                  minLength={8}
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all bg-white text-gray-900 placeholder-gray-400 hover:border-gray-300"
                />
                <p className="text-xs text-gray-500 ml-7">รหัสผ่านที่แพทย์จะใช้สำหรับเข้าสู่ระบบ</p>
              </div>
              ...
              <div className="flex items-center justify-end space-x-4 pt-4">
                ...
                <Button
                  ...
                  variant="success"
                  isLoading={loading}
                  description="สร้างบัญชีแพทย์ใหม่ในระบบ"
                >
                  เพิ่มแพทย์
                </Button>
              </div>
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              <strong>หมายเหตุ:</strong> สร้างบัญชีแพทย์ใหม่ในระบบ หลังจากสร้างแล้วแพทย์สามารถใช้ชื่อผู้ใช้และรหัสผ่านที่ระบุเข้าสู่ระบบได้ทันที
            </p>
          </div>
        </div>
      </div>
