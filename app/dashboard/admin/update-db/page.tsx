      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card mb-6">
          ...
          <Alert
            type="warning"
            title="คำเตือน"
            message="การอัปเดตฐานข้อมูลจะ: ลบและสร้าง indexes ใหม่ (เพื่อแก้ปัญหา duplicate indexes), อัปเดตเอกสารที่ไม่มี field ใหม่ (เช่น doctorRank), แสดงสถิติฐานข้อมูล"
          />
        </div>
