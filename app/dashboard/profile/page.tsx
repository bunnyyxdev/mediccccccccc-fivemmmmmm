        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mt-0.5">ข้อมูลบัญชีและบัตรประจำตัวแพทย์</p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 px-6 py-4 border-b border-gray-200">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-xl font-semibold text-gray-900">บัตรประจำตัวแพทย์</h2>
                </div>
              </div>
              <div className="p-6">
                <DoctorIDCard
            ...
            {user.doctorRank && (
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6 border-2 border-amber-100 shadow-sm">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">ตำแหน่งแพทย์</h3>
                </div>
