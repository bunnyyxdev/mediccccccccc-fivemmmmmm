...
export default function DoctorIDCard({
  name,
  doctorRank,
  username,
  email,
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4 relative overflow-hidden">
        ...
        <div className="relative flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-white font-bold text-lg">บัตรประจำตัวแพทย์</h3>
              <p className="text-blue-100 text-xs">Doctor ID Card</p>
            </div>
          </div>
      ...
      <div className="p-6">
        <div className="flex items-start space-x-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm">
              {role === 'admin' ? 'ผู้ดูแลระบบ' : getDoctorRankLabel(doctorRank) || 'แพทย์'}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 border-t border-gray-200 pt-4">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              <p className="text-xs text-gray-500 mb-0.5">User หมอ</p>
