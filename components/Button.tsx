...
export default function Button({
  ...
  const baseClasses = 'px-4 py-2 rounded-lg font-medium transition-smooth border-2 focus:outline-none focus:ring-2 focus:ring-offset-2 shadow-sm hover:shadow-md hover-lift button-press disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:transform-none';
