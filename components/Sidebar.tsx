...
export default function Sidebar({ role = 'doctor', onLogout }: SidebarProps) {
  ...
  // Ensure role is valid ('doctor' or 'admin'), default to 'doctor'
  const validRole: Role = (role === 'admin' || role === 'doctor') ? role : 'doctor';
